...
class IncrementalGP(GPy.models.GPRegression):
    ...
    """
    def __init__(self, X, Y, kernel=None, Y_metadata=None, normalizer=None, noise_var=1., mean_function=None, reoptimize=False):
    ...
    def _update(self, xs, ys):
        ...
        self.sampling_gp.set_XY(np.concatenate([self.sampling_gp.X, xs]), np.concatenate([self.sampling_gp.Y, ys]))
    ...
    def predict_xs(self, xs, full_cov=False, Y_metadata=None, kern=None,
